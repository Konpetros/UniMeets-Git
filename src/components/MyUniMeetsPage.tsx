    ...
    <Layout showHeader>
      <div className="flex-1 flex flex-col p-4 pb-20">
        ...
        <h2 className="text-xl font-extrabold text-gray-900 mb-4 flex items-center gap-2">
          <Calendar className="text-orange-500 w-5 h-5 animate-pulse" />
            ...
            loadingPosts ? (
              ...
              <div className="space-y-4">
                {myPosts.map((meet) => {
                   ...
                   return (
                     <div
                       ...
                       className={`p-4 bg-white border border-gray-200 rounded-2xl hover:border-gray-300 transition shadow-sm relative cursor-pointer group flex flex-col justify-between min-h-[120px] ${
                         isMuted ? 'opacity-60 bg-gray-50' : ''
                       }`}
                     >
                       ...
                       <div className="flex justify-between items-start gap-4">
                         ...
                         {countdown.active && (
                           <button
                             ...
                             className="p-2 bg-red-50 border border-red-200 text-red-600 rounded-xl hover:bg-red-100 transition duration-150"
                             title="Cancel Meetup"
                           >
                             <Trash2 size={14} />
                           </button>
                       ...
                       {/* Middle: Title */}
                       <div className="my-3">
                         <h3 className={`text-sm font-extrabold text-gray-800 leading-snug group-hover:text-orange-600 transition ${
                           isMuted ? 'line-through text-gray-400' : ''
                         }`}>
                           {meet.title}
                         </h3>
                       </div>
                       ...
                       {/* Bottom Row: Info */}
                       <div className="flex items-center justify-between border-t border-gray-100 pt-3 text-[11px] font-mono font-medium text-gray-500">
                         <div className={`flex items-center gap-1 ${isMuted ? 'text-gray-400' : 'text-amber-600'}`}>
                           <Clock size={12} />
               ...
               <div className="text-center py-16 px-4 bg-white border border-gray-200 rounded-2.5xl my-auto shadow-sm">
                 ...
                 <h3 className="text-gray-800 font-bold">Nothing here yet</h3>
                 ...
                 <button
                   ...
                   className="mt-6 px-5 py-2.5 bg-gradient-to-r from-orange-500 to-orange-400 hover:from-orange-600 hover:to-orange-500 text-white font-bold rounded-xl text-xs transition shadow-sm"
                 >
                   Create availability
                 </button>
               </div>
                     ...
                     >
                       ...
                       <div className="flex justify-between items-center mb-1">
                         <div className="flex items-center gap-2.5">
                           ...
                           />
                           <div>
                             <h4 className="text-xs font-bold text-gray-800">@{meet.creator_username}</h4>
                             <span className="text-[9px] text-gray-400 block font-mono truncate max-w-[150px]">
        ...
        <nav className="absolute bottom-0 left-0 right-0 h-16 bg-white/95 backdrop-blur-md border-t border-gray-200 flex items-stretch z-40">
          ...
          <button
            ...
            className="flex-1 flex flex-col justify-center items-center gap-1 text-gray-400 hover:text-gray-650 transition"
          >
            <UserIcon size={18} />
